...
class FASTSAM:
    def __init__(self, args) -> None:
        ...
        self.checkpoint = 'weights/FastSAM.pt'#'weights/FastSAM.pt'
    ...
    def get_unlabeled_samples(self, 
        ...
        everything_results = self.model(img_pil, device=self.device, retina_masks=True, imgsz=1024, conf=0.1, iou=0.1,) #conf=0.1, iou=0.9,)
